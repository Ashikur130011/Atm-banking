...
public class depositemoney extends javax.swing.JFrame {
    ...
    private void depositeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositeActionPerformed
        ...
        if("".equals(depo_money.getText())){
            ...
            JOptionPane.showMessageDialog(null, "Value of money must be an integer");
        }
        else if(!depo_money.getText().equals("")){
            float deposite_money = Float.parseFloat(depo_money.getText());
            String bal = Float.toString(new_balance + deposite_money);
            JOptionPane.showMessageDialog(null, "Are you sure you want to deposit money?");
            ...
            try {
                ...
                JOptionPane.showMessageDialog(type, ex);
            }
            finally{
                try{
                    ps.close();
