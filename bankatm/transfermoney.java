...
public class transfermoney extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        target_id = new javax.swing.JTextField();
        ...
        jLabel6.setText("Target Id:");

        target_id.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(target_id, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(101, 101, 101)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(target_id, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(25, 25, 25)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(deposite)
                    .addComponent(back))
    ...
    private void depositeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositeActionPerformed
        ...
        if("".equals(depo_money.getText())){
            ...
            JOptionPane.showMessageDialog(null, "Money Filed Must be a positive integer number");
        }
        else{
            float money = Float.parseFloat(depo_money.getText());
            if(new_balance <= money){
                JOptionPane.showMessageDialog(null, "Insufficient Balance");
            }
            else{
                String bal = Float.toString(new_balance - money);
                String target = target_id.getText();
                String Query2 = "SELECT * FROM `normauser` WHERE `user_id` = ?";
                String Query3 = "";
                String other_user_balance = null;
                float new_bal_2 = 0;
                ...
                try {
                    ...
                    rs = ps.executeQuery();
                    if(rs.next()){
                        new_bal_2 = Float.parseFloat(rs.getString("balance")) + money;
                        System.out.println(new_bal_2);
                        other_user_balance = String.valueOf(new_bal_2);
                    }
                ...
                if(!depo_money.getText().equals("")){
                    ...
                    Query3 = "UPDATE `normauser` SET `balance` =? WHERE `user_id`=?";
                    if(account_id.getText().equals(target_id.getText())){
                        JOptionPane.showMessageDialog(null, "Can't transfer money to yourself");
                    }else{
                        JOptionPane.showMessageDialog(null, "Are you sure you want to transfer money?");
                        try {
                            ps = myconnection.getConnection().prepareStatement(Query);
                            ps.setString(1, bal);
                            ...
                            if(ps.executeUpdate() > 0){
                                ...
                                ps.setString(1, other_user_balance);
                                ps.setString(2, target);
                                if(ps.executeUpdate() > 0){
                                    JOptionPane.showMessageDialog(null, "Transfer Money Successfull");
                                    balance.setText(bal);
                                    this.dispose();
                                    depo_money.setText("");
                                    target_id.setText("");
                                    ...
                                    JOptionPane.showMessageDialog(null, "Target Id field can't be empty");
                                }
                            ...
                            Logger.getLogger(depositemoney.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        finally{
                            try{
                                ps.close();
                    ...
                    JOptionPane.showMessageDialog(null, "Please Enter your money and Target id correctly");
                }
            }
        }
    ...
    private javax.swing.JTextField target_id;
